...
public class NewsCenterPager extends NewsCenterMenuBasePager {
    ...
    public NewsCenterPager(Context context, List<NewsBean.DataBean.ChildrenBean> childreanBean) {
        super(context);
    ...
    public void initData() {
       ...
       //关联Indicator
        indicator.setViewPager(details_viewpager);
